...
class Transforms():
    ...
    def __call__(self, image, landmarks, crops):
        ...
        image, landmarks = self.rotate(image, landmarks, angle=60)
...
if __name__ == "__main__":
    ...
    if not os.path.exists('weights_3000_epochs_cuda'):
        os.makedirs('weights_3000_epochs_cuda')
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        model_save_path = f'weights_3000_epochs_cuda/eyes_landmarks_epoch_{epoch}.pth'
