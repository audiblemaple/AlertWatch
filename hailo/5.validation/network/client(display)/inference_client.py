...
def main():
    ...
    while True:
        ...
        # print("Detected faces:", faces)  # Debug print
        ...
        for (x, y, w, h) in faces:
            ...
            # print("Landmarks detected:", landmarks)  # Debug print
        ...
        # Prepare tensor data
        tensor_array = np.array(all_landmarks, dtype=np.float32)
        # print("Tensor array before sending:", tensor_array)  # Debug print
        tensor_data = pickle.dumps(tensor_array, 0)
        tensor_size = len(tensor_data)

        # print("Frame size: {}, Tensor size: {}".format(frame_size, tensor_size))

        # Send frame and tensor data to the server
        try:
            client_socket.sendall(struct.pack(">L", frame_size) + frame_data + struct.pack(">L", tensor_size) + tensor_data)
            # print("new frame and tensor sent...")
