...
def main():
    ...
    while True:
        ...
        for (x, y, w, h) in faces:
            ...
            # Convert model output to string and display on frame
            output_text = str(infer_result.flatten())
            y0, dy = 20, 20
            for i, line in enumerate(output_text.split(',')):
                y = y0 + i * dy
                cv2.putText(frame, line, (10, y), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (255, 255, 255), 1, cv2.LINE_AA)
