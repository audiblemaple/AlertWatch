...
def preprocess_image(image, target_size):
    ...
    return expanded_image.astype(np.float32)  # Ensure the data type is float32
...
def main():
    ...
    # Load the HEF model
    hailo_inference = HailoInference(args.net, output_type='FLOAT32')
    ...
    while True:
        ...
        for (x, y, w, h) in faces:
            ...
            landmarks = (landmarks * [w, h]) + [x, y]  # Scale and shift landmarks back to the face ROI
